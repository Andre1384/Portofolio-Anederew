...
function Home() {
  return (
    ...
    >
      ...
      With a deep passion for technology, I am committed to continuously developing my skills and knowledge, especially in creating innovative and functional websites and mobile applications.
      </p>
